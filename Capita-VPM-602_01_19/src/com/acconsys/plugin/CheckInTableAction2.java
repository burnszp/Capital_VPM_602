...
import com.acconsys.ui.CheckInFrameTable2;
import com.mentor.chs.plugin.IXApplicationContext;
import com.mentor.chs.plugin.action.IXApplicationAction;
import com.mentor.chs.plugin.action.IXLogicAction;

public class CheckInTableAction2 implements IXLogicAction,IXApplicationAction {
	...
	public boolean execute(IXApplicationContext context) {
		...
		CheckInFrameTable2 checkInFrameTable2 = new CheckInFrameTable2(context);
		checkInFrameTable2.setVisible(true);
		return true;
	}
